                    ...
                    {meeting.actionItems && meeting.actionItems.length > 0 && (
                        <Card>
                            <CardHeader>
                                <CardTitle>AI-Extracted Action Items</CardTitle>
                                <CardDescription>
                                    Automatically extracted using Claude AI
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <ActionItemsTable actionItems={meeting.actionItems} />
...
// ## **The Three Patterns in Action**
// ```
// Pattern 1: Server Parent → Client Child
//     page.tsx (Server) → <MeetingProvider meeting={meeting}>
//     Passes data down as props to the Provider, which initializes context state

// Pattern 2: Client Parent → Server Children  
//     <MeetingProvider> wraps all the static cards
//     Those cards are Server Components passed as children 
//     They DON'T become Client just because Provider is Client 

// Pattern 3: Decomposition
//     90% of page = static HTML (Server)
//     Only MeetingActions = Client (needs useState + useRouter)
//     MeetingActions gets meeting from context, not props  